...
Instructs an OpenCode session to autonomously scan, filter, and write L1 observations.
"""
import os
import sys
import time
...
3. **扫描与过滤**：自主扫描根目录（{workspace_root}）下的变动。
...
7. **汇报**：完成后，只需简短说明是幂等跳过，还是已成功写入针对 {target_date} 的观测。
"""
