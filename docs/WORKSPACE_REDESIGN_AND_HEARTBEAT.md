...
5. `projects/<project>/chat_session_distillations/`
...
- `chat_session_distillations/` 是连接聊天认知与文件系统记忆的桥，适合作为高价值补充输入，但不替代 `handoff` 和 `decisions.md`。
